...
from .views.wishlist_view import wishlist_view, wishlist_toggle_view, remove_wishlist_view
...
urlpatterns = [
    ...
    path('products/wishlist/remove/<int:product_id>/', remove_wishlist_view, name='remove_wishlist'),
